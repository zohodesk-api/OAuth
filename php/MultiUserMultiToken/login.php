...
<body>
	<form method="POST">
		...
		<div class="inp-item">
			...
			<input id="oauth_email" required name="email" type="email" placeholder="Your Email Address" value="<?=isset($_POST['email'])?isset($_POST['email']):""?>" />
		</div>
		<div class="inp-item">
			<label for="oauth_password"> Password </label>
			<input id="oauth_password" required name="password" type="password" placeholder="Your Password" value="<?=isset($_POST['password'])?isset($_POST['password']):""?>" />
		</div>
		<div class="inp-item">
